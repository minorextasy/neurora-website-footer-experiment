  ...
  return (
    <div className="border-b border-primary-foreground/10">
      ...
      >
        ...
        <span
          className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-primary-foreground/20 text-primary-foreground/70 transition-all duration-300 group-hover:border-accent/50 group-hover:text-accent ${
            open ? "rotate-180 border-accent/50 text-accent" : ""
          }`}
        >
...
const Footer = () => {
  ...
  const localize = (path: string) =>
    getLocalizedPath(path, i18n.language);

  const companyLinks = [
    {
      href: localize("/about"),
      label: t("footer.groups.company.items.about"),
    },
    {
      href: localize("/services"),
      label: t("footer.groups.company.items.handle"),
    },
    {
      href: localize("/neurora-operating-system"),
      label: t("footer.groups.company.items.process"),
    },
    {
      href: localize("/contact"),
      label: t("footer.groups.company.items.contact"),
    },
  ];
  ...
  const serviceLinks = [
    ...
    {
      href: `${localize("/")}#communication`,
      label: t("footer.groups.operations.items.communication"),
    },
    {
      href: `${localize("/neurora-operating-system")}#financial-control`,
      label: t("footer.groups.operations.items.financial"),
    },
    {
      href: `${localize("/neurora-operating-system")}#automation`,
      label: t("footer.groups.operations.items.automation"),
    },
    {
      href: `${localize("/neurora-operating-system")}#legal-protection`,
      label: t("footer.groups.operations.items.legal"),
    },
  ];
  ...
  const navigationLinks = [
    ...
    {
      href: localize("/neurora-operating-system"),
      label: t("header.links.howItWorks"),
    },
    {
      href: localize("/contact"),
  ...
  const legalLinks = [
    {
      ...
      label: t("footer.groups.company.items.privacyPolicy"),
    },
  ];

  const rows = [
    {
      day: t("footer.hours.monday"),
      hours: t("footer.hours.weekdaysHours"),
    },
    {
      day: t("footer.hours.tuesday"),
      hours: t("footer.hours.weekdaysHours"),
    },
    {
      day: t("footer.hours.wednesday"),
      hours: t("footer.hours.weekdaysHours"),
    },
    {
      day: t("footer.hours.thursday"),
      hours: t("footer.hours.weekdaysHours"),
    },
    {
      day: t("footer.hours.friday"),
      hours: t("footer.hours.fridayHours"),
    },
    {
      day: t("footer.hours.saturday"),
      hours: t("footer.hours.closed"),
    },
    {
      day: t("footer.hours.sunday"),
      hours: t("footer.hours.closed"),
    },
  ];
      ...
      <div className="container-narrow relative z-10 py-10 lg:py-14">
        ...
        <div className="flex flex-col gap-6 border-b border-primary-foreground/10 pb-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-primary-foreground/60">
              {t("hero.subtitle")}
            </p>
          </div>
        ...
        {/* ============================================================
            IRONFX-STYLE EXPANDABLE NAVIGATION
        ============================================================ */}
        <div className="mt-2">
          <AccordionSection
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {companyLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-sm text-primary-foreground/65 transition-colors duration-300 hover:text-accent"
                >
                  {link.label}
                </a>
              ))}
        ...
        {/* ============================================================
            INFORMATION AREA
        ============================================================ */}
        <div className="mt-10 border-t border-primary-foreground/10 pt-9">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-primary-foreground/65 transition-colors duration-300 hover:text-accent"
                >
                  <Mail
                ...
                <a
                  href={localize("/contact")}
                  className="mt-2 inline-flex w-fit text-sm font-semibold text-accent transition-opacity duration-300 hover:opacity-70"
                >
                  {t("header.cta")}
                </a>
              </div>
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full border border-[#F5D76E]/40 bg-[#F5D76E]/10 transition-all duration-300 hover:bg-[#F5D76E]/20"
              >
                <img
